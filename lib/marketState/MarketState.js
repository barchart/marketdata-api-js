...
module.exports = (() => {
	 ...
	 * <p>Access the singleton instance using the {@link Connection.getMarketState}
	 * function.</p>
	 *
	 * @public
	 */
	class MarketState {
		 ...
		 * @public
		 * @param {string} symbol
		 * @param {function} callback - Optional. A callback that is invoked with the {@link CumulativeVolume} instance.
		 ...
		 * @public
		 * @param {string} symbol
		 * @param {function} callback - Optional. A callback that is invoked with the {@link Profile} instance.
