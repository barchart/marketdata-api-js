module.exports = (() => {
	...
	class Quote {
		constructor(symbol) {
			...
			/**
			 * @property {Date|null} time - A timezone-aware version of {@link Profile#lastUpdate}. This property will only have a value when both (a) the exchange timezone is known; and (b) the client computer's timezone is known.
			 * @public
			 * @readonly
			 */
			...
			/**
			 * @property {Date|null} time - A timezone-aware version of {@link Profile#time}. This property will only have a value when both (a) the exchange timezone is known; and (b) the client computer's timezone is known.
			 * @public
			 * @readonly
			 */
			this.timeUtc = null;
