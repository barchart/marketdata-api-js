module.exports = (() => {
	...
	class CumulativeVolume {
		 ...
		 * @param {function} handler - Callback notified when event occurs.
		 */
		 ...
		 *
		 * @ignore
		 * @param {string} eventType - the event which was registered using {@link CumulativeVolume#on}.
		 * @param {function} handler - the callback which was registered using {@link CumulativeVolume#on}.
		 */
