...
module.exports = (() => {
	...
	const ConnectionInternal = function(marketState) {
		...
		function off() {
			...
			const removeHandler = (listeners) => {
				let updatedListeners = (listeners || []).slice(0);
			...
			// ES6 Translation to continue here ...
	...
	class Connection extends ConnectionBase {
		constructor() {
			...
			this._internal = new ConnectionInternal(this.getMarketState());
		}
