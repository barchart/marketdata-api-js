...
module.exports = (() => {
	...
	regex.cmdty = { };
	regex.cmdty.short = /^(AE|BC|BE|BL|CA|CB|EI|EU|CF|UD)(.*)(\.CS)$/i;
	regex.cmdty.long = /^(BCSD-|BEA-|BLS-|CANS-|EIA-|EURS-|CFTC-|USCB-|USDA-)/i;
	regex.cmdty.alias = /^(AE|BC|BE|BL|CA|CB|EI|EU|CF|UD|BCSD-|BEA-|BLS-|CANS-|EIA-|EURS-|CFTC-|USCB-|USACE-|USDA-)(.*)(\.CM)$/i;
