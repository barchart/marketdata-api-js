...
module.exports = (() => {
	...
	class ConnectionBase {
		...
		/**
		 * Initiates a subscription to an {@link Subscription.SubscriptionType} and
		 * registers the callback for notifications.
		 *
		 * @public
		 * @param {Subscription.SubscriptionType} subscriptionType
		 * @param {function} callback - notified each time the event occurs
		 * @param {String=} symbol - A symbol, if applicable, to the given {@link Subscription.SubscriptionType}
		 */
		on() {
		...
		/**
		 * Stops notification of the callback for the {@link Subscription.SubscriptionType}.
		 * See {@link ConnectionBase#on}.
		 *
		 * @public
		 * @param {Subscription.SubscriptionType} subscriptionType - the {@link Subscription.SubscriptionType} which was passed to {@link ConnectionBase#on}
