...
module.exports = (() => {
	...
	class ConnectionBase {
		 ...
		 *
		 * @public
		 * @param {string} event - the event which was registered using {@link ConnectionBase#on}.
		 * @param {function} callback - the callback which was registered using {@link ConnectionBase#on}.
		 */
		off() {
