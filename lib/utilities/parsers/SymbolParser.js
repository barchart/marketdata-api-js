...
module.exports = (() => {
	...
	class SymbolParser {
		...
		/**
		 * Returns true if the symbol represents an external index (e.g. the S&P 500);
		 * false otherwise.
		 *
		 * @public
		 * @static
		...
		/**
		 * Returns true if the symbol represents an Barchart-calculated sector
		...
		/**
		 * Returns true if the symbol represents an Barchart-calculated, cmdty-branded
		 * index; false otherwise.
		 *
		 * @public
		 * @static
		...
		static getIsC3(symbol) {
			return is.string(symbol) && (types.c3.preferred.test(symbol) || types.c3.alias.test(symbol));
		}
