...
module.exports = function () {
	...
	var CSTATS = ['BLS-LIQUOR-PRICE-USA-12011.CM', 'BLS-BEVALCOHO-PRICE-USA-12010.CM', 'BLS-LIQUOR-PRICE-USA-12012.CM'];
...
},{"./connection/index":5,"./marketState/index":12,"./messageParser/index":13,"./util/index":22}],8:[function(require,module,exports){
'use strict';
...
},{"./../common/lang/object":3}],9:[function(require,module,exports){
'use strict';
...
},{"./../util/parseSymbolType":24,"./../util/priceFormatter":25}],11:[function(require,module,exports){
'use strict';
  ...
  */
	...
	function retrieveSnapshotsUsingGetCmdtyStats(symbols, username, password) {
		return Promise.all(symbols.map(function (symbol) {
			return retrieveSnapshotUsingGetCmdtyStats(symbol, username, password).catch(function () {
