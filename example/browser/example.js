...
module.exports = function () {
	...
	var C3_OLD = ['C3:AL79MRM1', 'C3:BSP9WGQ1', 'C3:RA10BGM1'];
	var CMDTY_OLD = ['BC5L09YB.CM', 'EI3E06EI.CM', 'EI3E06EJ.CM', 'USDA-CORN-COND-EXC-AL-2528.CM', 'EURS-BEET-PRICE-SELL-GBR-33877.CM', 'EUJU0Q51.CM'];
	...
	function retrieveSnapshots(symbols, username, password) {
		return Promise.resolve().then(function () {
			...
			symbolsToUse.forEach(function (symbol) {
				var concrete = getConcreteSymbol(symbol);
			...
			return Promise.all(promises).then(function (results) {
				var quotes = array.flatten(results, true);

				quotes.forEach(function (quote) {
					var concrete = quote.symbol;
